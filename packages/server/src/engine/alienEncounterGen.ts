...
export const ALIEN_ENCOUNTER_TABLE: EncounterTableEntry[] = [
  {
    ...
    canRespond: true,
    acceptLabel: 'Scan erlauben',
    declineLabel: 'Abschirmen',
    repOnAccept: 8,
    repOnDecline: -3,
    dialogByTier: {
  ...
  },
  {
    ...
    dialogByTier: {
      ...
      NEUTRAL:
        'Konsortium-Händler nähert sich — Sonderrabatt 15% auf nächsten Handel. Zeitlich begrenzt.',
      FREUNDLICH:
        'Konsortium-Partner grüßt euch herzlich! Exklusiver Handelszugang für bewährte Menschheit.',
    },
  },
  {
    ...
    eventType: 'photo_op',
    canRespond: true,
    acceptLabel: 'Für Fotos posieren',
    declineLabel: 'Ablehnen',
    repOnAccept: 12,
    repOnDecline: -5,
    dialogByTier: {
      ...
      NEUTRAL:
        'Touristengilde-Luxusliner nähert sich — "Dürfen wir Fotos machen? SO authentisch menschlich!"',
      FREUNDLICH:
        'Touristengilde-VIP-Liner! "Menschheit ist unser beliebtestes Reiseziel — kostenlose Tour?"',
    },
  },
  {
    factionId: 'scrappers',
    ...
    canRespond: true,
    acceptLabel: 'Anschauen',
    declineLabel: 'Ignorieren',
    repOnAccept: 7,
    repOnDecline: 0,
    dialogByTier: {
      FEINDSELIG:
        'Scrapper-Bande kreist euer Schiff ein. "Entweder handeln oder wir nehmen uns was wir brauchen."',
      NEUTRAL:
        'Scrapper-Schwarzmarkt — "Psst. Haben was Interessantes. Nur Tausch, keine Credits."',
      FREUNDLICH:
        'Scrapper-Freunde! "Für euch das Beste aus unserer Sammlung — alter Schwur unter Raumfahrern."',
    },
  },
  {
    ...
    dialogByTier: {
      FEINDSELIG:
        'Mirror Mind Kontakt — Sie zeigen euer verzerrtes Spiegelbild. Angst spiegelt Angst.',
      NEUTRAL:
        'Mirror Mind Kontakt — Sie zeigen euch euer eigenes Gesicht. Keine Worte. Nur ein Spiegel.',
      FREUNDLICH:
        'Mirror Mind Kontakt — Sie zeigen euch ein strahlendes Spiegelbild. Vertrauen spiegelt Vertrauen.',
    },
  },
  {
    ...
    dialogByTier: {
      FEINDSELIG:
        'Silent Swarm Drohnen schwärmen euer Schiff an. Keine Kommunikation. Nur Bedrohung.',
      NEUTRAL: 'Silent Swarm Drohne folgt eurem Schiff — Keine Kommunikation. Nur Beobachtung.',
      FREUNDLICH:
        'Silent Swarm Eskorte begleitet euer Schiff. Keine Worte — aber Schutz durch Präsenz.',
    },
  },
];
