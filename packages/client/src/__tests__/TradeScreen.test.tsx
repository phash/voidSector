...
describe('TradeScreen', () => {
  ...
  it('shows NPC trade at station with cargo info (no station data yet)', () => {
    mockStoreState({
      ...
      credits: 200,
      cargo: { ore: 3, gas: 1, crystal: 0, slates: 0, artefact: 0, artefact_drive: 0, artefact_cargo: 0, artefact_scanner: 0, artefact_armor: 0, artefact_weapon: 0, artefact_shield: 0, artefact_defense: 0, artefact_special: 0, artefact_mining: 0 },
      npcStationData: null,
    });
    render(<TradeScreen />);
    expect(screen.getByText(/NPC PREISE/)).toBeTruthy();
  ...
  it('shows KONTOR tab when kontorOrders are present at station', () => {
    mockStoreState({
      ...
      credits: 200,
      cargo: { ore: 5, gas: 0, crystal: 0, slates: 0, artefact: 0, artefact_drive: 0, artefact_cargo: 0, artefact_scanner: 0, artefact_armor: 0, artefact_weapon: 0, artefact_shield: 0, artefact_defense: 0, artefact_special: 0, artefact_mining: 0 },
      kontorOrders: [
        {
          id: 'ko1',
