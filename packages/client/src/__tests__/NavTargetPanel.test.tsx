...
describe('NavTargetPanel', () => {
  beforeEach(() => {
    ...
    mockStoreState({
      ...
      discoveries: { '0:0': { x: 0, y: 0, type: 'empty', seed: 42, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] } },
      selectedSector: null,
    });
  });
  ...
  it('enables ENGAGE when target is valid and discovered', () => {
    mockStoreState({
      ...
      discoveries: {
        ...
        '5:5': { x: 5, y: 5, type: 'empty', seed: 100, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
      },
      fuel: { current: 100, max: 100 },
      ap: { current: 100, max: 100, lastTick: Date.now(), regenPerSecond: 0.5 },
      autopilot: null,
  ...
  it('calls sendStartAutopilot on ENGAGE click', () => {
    mockStoreState({
      ...
      discoveries: {
        '0:0': { x: 0, y: 0, type: 'empty', seed: 42, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
        '3:4': { x: 3, y: 4, type: 'station', seed: 99, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
      },
      fuel: { current: 100, max: 100 },
      ap: { current: 100, max: 100, lastTick: Date.now(), regenPerSecond: 0.5 },
      autopilot: null,
  ...
  it('sends hyperjump flag when checkbox is checked', () => {
    mockStoreState({
      ...
      discoveries: {
        '0:0': { x: 0, y: 0, type: 'empty', seed: 42, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
        '2:2': { x: 2, y: 2, type: 'empty', seed: 77, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
      },
      fuel: { current: 100, max: 100 },
      ap: { current: 100, max: 100, lastTick: Date.now(), regenPerSecond: 0.5 },
      autopilot: null,
  ...
  it('shows cost preview when target is set', () => {
    mockStoreState({
      ...
      discoveries: {
        '0:0': { x: 0, y: 0, type: 'empty', seed: 42, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
        '5:0': { x: 5, y: 0, type: 'empty', seed: 10, discoveredBy: null, discoveredAt: null, metadata: {}, environment: 'empty' as const, contents: [] },
      },
      fuel: { current: 100, max: 100 },
      ap: { current: 100, max: 100, lastTick: Date.now(), regenPerSecond: 0.5 },
      autopilot: null,
