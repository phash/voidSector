...
export declare const RESOURCE_REGEN_PER_MINUTE = 1;
export declare const CRYSTAL_REGEN_PER_MINUTE: number;
export declare const RESOURCE_REGEN_DELAY_MINUTES = 5;
...
export declare const NEBULA_SAFE_ORIGIN = 200;
