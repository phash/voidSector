// --- Helpers ---
function branch(id, name, desc, b) {
    return {
...
function mod(id, name, desc, parentId, b, group, effects) {
    return {
...
function spec(id, name, desc, parentId, b, group, effects) {
    return {
...
function leaf(id, name, desc, parentId, b, group, stat, value, penalty) {
    const eff = { type: 'stat_bonus', target: stat, value };
    if (penalty)
        eff.penalty = penalty;
    return {
...
export function getExclusiveGroup(nodeId) {
