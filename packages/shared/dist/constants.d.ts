...
export declare const REFINERY_GAS_PER_TICK = 1;
export declare const REFINERY_FUEL_PER_GAS = 100;
export declare const REFINERY_FUEL_MAX = 20000;
export declare const SENSOR_PIRATE_REDUCTION_PER_LEVEL = 0.15;
export declare const SENSOR_PIRATE_REDUCTION_MAX = 0.9;
...
export declare const NEBULA_ZONE_GRID = 25;
export declare const NEBULA_ZONE_CHANCE = 0.54;
export declare const NEBULA_ZONE_MIN_RADIUS = 2.5;
export declare const NEBULA_ZONE_MAX_RADIUS = 6;
export declare const NEBULA_SAFE_ORIGIN = 25;
