...
- **Game URL**: `https://adapted-mothers-work-article.trycloudflare.com`
- **Admin API**: `https://adapted-mothers-work-article.trycloudflare.com/admin/api`
- **Admin Token**: `vs-admin-2026`
...
```bash
curl -X POST "https://adapted-mothers-work-article.trycloudflare.com/admin/api/stories" \
  -H "Authorization: Bearer vs-admin-2026" \
